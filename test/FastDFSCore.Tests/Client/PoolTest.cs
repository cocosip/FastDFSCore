...
namespace FastDFSCore.Tests.Client
{
    public class PoolTest
    {
        ...
        public void GetConnection_Test()
        {
            ...
            var pool = new Pool(_mockScheduleService.Object, _mockConnectionPoolFactory.Object, ipEndPoint, 2, 300, 20); _mockConnectionPoolFactory.Setup(x => x.CreateConnection(It.Is<ConnectionAddress>(v => v.ServerEndPoint == ipEndPoint), It.Is<Action<Connection>>(x => true))).Returns(connection);
